...
int main()
{
    ...
    lista.push_back(TPoint{"MIFARMA,Farmacia,18,89,C"});
    lista.push_back(TPoint{"PUCP,Universidad,89,64,A"});
    lista.push_back(TPoint{"PETROPERU,Grifo,5,13,A"});
    lista.push_back(TPoint{"FUSEN,Chifa,33,56,C"});
    lista.push_back(TPoint{"PIURANO,Restaurant,75,19,D"});
    lista.push_back(TPoint{"RUSTICA,Discoteca,36,11,C"});
    lista.push_back(TPoint{"GOUPH,Bar,77,52,C"});
    lista.push_back(TPoint{"ESTADIO_NACIONAL,Estadio,9,14,C"});
